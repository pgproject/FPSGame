...
public class GeneralAccess : MonoBehaviour
{
    ...
    [SerializeField] private PlayerInventoryExchnage m_playerEquipmentExchange;
    public PlayerInventoryExchnage PlayerEquipmentExchange => m_playerEquipmentExchange;
